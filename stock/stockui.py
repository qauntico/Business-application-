...
"")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_2.setText(_translate("Dialog", "Qauntity"))
        self.label_3.setText(_translate("Dialog", "Unit"))
        self.label_4.setText(_translate("Dialog", "Product Name"))
        self.label_5.setText(_translate("Dialog", "Unit Cost"))
        self.label_6.setText(_translate("Dialog", "Supplier ID"))
